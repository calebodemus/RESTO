<?php
    ...
    $query = 'SELECT *, carte.libelle titre, carte.id id_carte FROM carte,categorie a, categorie b WHERE a.id = carte.id_categorie AND a.id_parent = b.id AND b.libelle = "boisson"';
    //$query = 'SELECT carte.libelle c FROM carte,categorie WHERE categorie.id = carte.id_categorie AND categorie.libelle = "plat"';
